const abi = [
  {
    inputs: [
      ...
      {
        internalType: "contract IBitToken",
        name: "_token",
        type: "address",
      },
      {
  ...
  {
    inputs: [],
    name: "allowPenaltyWithdrawAfter",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  {
    inputs: [],
    name: "penaltyWithdrawalsEnabled",
    outputs: [
      {
        internalType: "bool",
        name: "",
